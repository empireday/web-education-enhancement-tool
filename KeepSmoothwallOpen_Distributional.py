...
import time
import getpass
#fuck smoothwall, as of writing this they implemented a feature that logged you outta the internet with a smoothwall webpage every 10 mins
#this program is for resending the TOTALLY UNENCRYPTED HTTP POST

#FUCK SMOOTHWALL

#this could be less ghetto but whatever lol
user = input("Put in your username my dude, this shits unencoded:   ")
print("thanks fam")

passvar = getpass.getpass('Alright dude now for the password- Ive set it so the characters are invisible so dont freak out:   ')


#YO I THOUGHT I NEEDED THIS SECTION WITH THE COOKIE BUT APPARENTLY THATS BULLSHIT LOL,
#kept for fun archive purposes.
'''
print ("Now pass the computer to mr. deadfox the hackerman so he can sort out the cookie. ")
time.sleep(5)
...
while True:
    ...
    print("FUCK THE LEFT, TAXATION IS THEFT.")
    time.sleep(15)
# 1:30 minute wait between requests please.
# Should be obvious as to why constant requests is bad

    print("I am the world snake, Jourmangand.")
    time.sleep(17)


    print("Fuck smoothwall, the real villains making us fuck with the system. ")
    time.sleep(15)
    print("D E A D  F O X")
    time.sleep(40)


#, cookies={"SecureLogin": var_cookie}